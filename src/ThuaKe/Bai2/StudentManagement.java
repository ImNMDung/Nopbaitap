...
public class StudentManagement {
	...
	public void write(Student[] student) { 
        ...
        try {   
            FileOutputStream f = new FileOutputStream("F:\filename.txt");   // tao file filename.txt
    ...
    public Student[] read() {
        ...
        try {   
            FileInputStream f = new FileInputStream("F:\\filename.txt"); // tao file f tro den student.dat
